...
export default function DashboardContent() {
  const { activeTab, showModal, modalType, selectedOrder } = useDashboard();

  return (
    <div className="flex h-screen bg-gray-50 text-gray-800 overflow-hidden">
      {/* Sidebar - hidden on smaller screens */}
      <div className="hidden laptop-lg:block w-[clamp(10.5rem,20vw,18rem)] flex-shrink-0 border-r border-gray-200">
        <DashboardSidebar />
      </div>
